...
const ServiceCard = ({ service , index}) => {
  ...
  return (
    ...
    ref={divRef} onMouseMove={handleMouseMove}>
        ...
        from-blue-500 via-indigo-500 to-purple-500 w-75 h-75 absolute
        z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? "opacity-70" : "opacity-0"}  `} 
        style={{top: position.y -150,
            left: position.x -150,}} />

            <div className='flex items-center gap-10 p-8 hover:p-7.5 hover:m-0.5
            tranisition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
