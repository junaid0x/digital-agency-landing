  ...
  return (
    ...
    lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px]
        font-medium xl:leading-23.75 max-w-5xl'>Turning Imagination into
        <span className='bg-linear-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text'>Digital</span> impact</motion.h1>
      ...
      viewport={{once:true}}
       className='text-sm sm:text-lg font-medium
         text-gray-500 dark:text-white/75 max-w-4/5
         sm:max-w-lg pb-3'>We are a team of creative designers and developers
        who are passionate about creating stunning websites and applications
        that help businesses grow.</motion.p>
