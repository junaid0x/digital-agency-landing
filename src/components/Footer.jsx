    ...
    sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='space-y-5 text-gray-700 dark:text-gray-400'>
                ...
                <p className='max-w-md'>From strategy to execution, we help businesses thrive in the digital age.</p>
      ...
      <hr className='border-gray-300 dark:border-gray-600 my-6' />
        ...
        className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between
        gap-4 flex-wrap'>
